...
float Kp = 1.0; // scales the force of correction by the lateral fans
float Kv = -0.01; // scales the force of dampening by the lateral fans around the target orientation
